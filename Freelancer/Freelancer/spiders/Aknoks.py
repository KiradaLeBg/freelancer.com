...
from Freelancer.items import JobItem
from Freelancer.itemloader import JobItemLoader
class AknoksSpider(scrapy.Spider):
    name = "Aknoks"
...
#
    ...
    def get_info(self,response):
        ...
        loader.add_css('job_title', 'h1.PageProjectViewLogout-projectInfo-title::text')
        loader.add_css('description', 'div.PageProjectViewLogout-detail p::text')
        loader.add_css('location', 'span[itemprop="addressLocality"]::text')
        loader.add_css('price', 'p.PageProjectViewLogout-projectInfo-byLine::text')
        loader.add_xpath('proposal', '//*[@id="main"]/div/div/div/div[1]/section/div/div[1]/div[2]/div/span[1]/text()')
